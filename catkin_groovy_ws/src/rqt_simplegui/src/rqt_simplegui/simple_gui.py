...
from TorsoNode import TorsoNode
...
class SimpleGUI(Plugin):
    ...
    def __init__(self, context):
        ...
        button_box.addWidget(self.create_button('Torso ^'), 6, 5)
        button_box.addWidget(self.create_button('Torso v'), 7, 5)
    ...
    def torso_down(self):
        self.show_text_in_rviz('Robot Torso Will Move Down')
        self.torsonode.lowerTorso()
        speechLabel = 'Torso is moving down'

    def torso_up(self):
        self.show_text_in_rviz('Robot Torso Will Move Up')
        self.torsonode.raiseTorso()
        speechLabel = 'Torso is moving up'
    ...
    def command_cb(self):
        ...
        if (button_name == 'Speak'):
            ...
            self.head_left()
        elif (button_name == 'Torso ^'):
            self.torso_up()
        elif (button_name == 'Torso v'):
            self.torso_down()
